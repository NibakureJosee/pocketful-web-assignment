  ...
  return (
    <div className="h-screen bg-violet-600 flex">
      <div className="w-[28%] h-[40rem] bg-white flex flex-col mt-8 ml-[28rem] rounded-[24px] overflow-hidden ">
        ...
        <h1 className="font-bold mt-2 text-center text-[21px] text-violet-600">
          Welcome to Bardeen
        </h1>
        <p className=" mt-1 text-center text-[15px] text-gray-400">
        ...
        <div>
          <form className=" w-full max-auto bg-white p-4  h-screen">
            <div className="flex flex-col mb-2 mt-2 ">
              <input
                className="border p-4 rounded-[10px]   outline-none"
                type="text"
            ...
            <button className="border w-full my-4 py-2 bg-violet-600 rounded-lg text-white font-bold  text-[18px]  hover:bg-violet-700 relative">
              Signup
            </button>
            ...
            <button className="mt-6 border w-full  py-1  rounded-lg  text-[14px] font-bold relative flex flex-row indent-3 items-center text-gray-700">
